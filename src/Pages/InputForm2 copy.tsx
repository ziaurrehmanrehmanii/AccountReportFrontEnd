  ...
  return (
    <div className="mx-auto p-4 h-screen flex flex-col">
      <div className="flex flex-col md:flex-row gap-8 flex-grow overflow-hidden">
        <div className="tabs-container w-full md:flex md:gap-8">
          <Tabs defaultValue="form" className="w-full md:w-1/3">
            ...
            <TabsContent value="form" className="w-full">
              <div className="w-full p-2 overflow-y-auto flex items-center justify-center border-r border-gray-200 pr-8">
          ...
          <Tabs defaultValue="table" className="w-full md:w-2/3">
